...
public class UserDAO {
    ...
    private static final String SEARCH_USER = "SELECT TOP 2 userID, fullName, roleID  FROM tblUsers";
    ...
    public List<UserDTO> getListUser2() {
        List<UserDTO> listUser = new ArrayList<>();
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
    ...
    public boolean createV2(UserDTO user) throws ClassNotFoundException, SQLException, NamingException {
        boolean result = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        try {
